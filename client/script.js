...
// CODE HERE
const hbColorChange = (event) =>{
    event.target.style.backgroundColor = "black"
    event.target.style.color= "white"
}
sayHelloButton.addEventListener("mouseover", hbColorChange)
...
const repeatMyParam = () => {
   axios.get(`${baseURL}/repeat/param-test`)
   .then((response) =>{
...
document.getElementById('query-button').addEventListener("click", makeRequest)
////////////////
//INTERMEDIATE//
////////////////
...
/*
    ...
    When I didn't send any queries on the URL, there were error codes. 
    2: Send more than 1 query on the URL -- what happened? 
    When I sent more than one query on the URL, both were returned.  
*/
